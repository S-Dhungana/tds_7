...
svmfit5_comcov_rad = svm(formula = status ~ ., data = train5_comcov, type = 'C-classification', kernel = 'radial')
svmfit5_comcov_rad

save(svmfit5_comcov_rad, file = "/rds/general/project/hda_students_data/live/Group7/General/Sarvesh/Data/svm5fit_comcov_rad.rda")

## SVM 1 year algorithm
svmfit1_comcov_rad = svm(formula = status ~ ., data = train1_comcov, type = 'C-classification', kernel = 'radial')
svmfit1_comcov_rad

save(svmfit1_comcov_rad, file = "/rds/general/project/hda_students_data/live/Group7/General/Sarvesh/Data/svm1fit_comcov_rad.rda")
