...
svmfit5_ccb_rad = svm(formula = status ~ ., data = train5_ccb, type = 'C-classification', kernel = 'radial')
svmfit5_ccb_rad

save(svmfit5_ccb_rad, file = "/rds/general/project/hda_students_data/live/Group7/General/Sarvesh/Data/svm5fit_ccb_rad.rda")

## SVM 1 year algorithm
svmfit1_ccb_rad = svm(formula = status ~ ., data = train1_ccb, type = 'C-classification', kernel = 'radial')
svmfit1_ccb_rad

save(svmfit1_ccb_rad, file = "/rds/general/project/hda_students_data/live/Group7/General/Sarvesh/Data/svm1fit_ccb_rad.rda")
