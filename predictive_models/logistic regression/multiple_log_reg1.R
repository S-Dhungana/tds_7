data<-readRDS("/rds/general/project/hda_students_data/live/Group7/General/Final/data1_final.rds")
...
saveRDS(perf, "/rds/general/project/hda_students_data/live/Group7/General/Final/perf1.rds")
