data<-readRDS("/rds/general/project/hda_students_data/live/Group7/General/Final/data_cooccurent_final.rds")
...
saveRDS(perf, "/rds/general/project/hda_students_data/live/Group7/General/Final/perf_coc.rds")
