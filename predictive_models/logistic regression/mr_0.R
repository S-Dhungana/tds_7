data<-readRDS("/rds/general/project/hda_students_data/live/Group7/General/Final/new0.rds")
...
saveRDS(perf, "/rds/general/project/hda_students_data/live/Group7/General/Final/perf0_new.rds")