...
for (i in 1:10){
  data <- readRDS(paste0("/rds/general/project/hda_students_data/live/Group7/General/Final/LASSO/stability_analysis/Lasso_stab_comor_cov_bio1/Lasso_stab_comor_cov_bio1_", i, ".rds"))
...
pdf("/rds/general/project/hda_students_data/live/Group7/General/Final/LASSO/stability_analysis/barplots/stability_comor_cov_bio1.pdf")
