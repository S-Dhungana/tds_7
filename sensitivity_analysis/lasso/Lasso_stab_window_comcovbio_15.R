...
#Load data
everything <- readRDS("/rds/general/project/hda_students_data/live/Group7/General/Final/Sensitivity_analysis/comorbidities_covariates_biomarkers_1_5.rds")
...
saveRDS(lasso_coef, paste0("/rds/general/project/hda_students_data/live/Group7/General/Final/LASSO/stability_analysis/window15/Lasso_stab__window_comor_cov_bio15_", ichunk, ".rds"))
