...
#Load data
test <- readRDS("/rds/general/project/hda_students_data/live/Group7/General/Final/Model_dataset/comorbidities_bio_covariates_test5.rds")
train <- readRDS("/rds/general/project/hda_students_data/live/Group7/General/Final/Model_dataset/comorbidities_covariates_bio_train5.rds")
...
matched_80 <- readRDS("/rds/general/project/hda_students_data/live/Group7/General/Final/LASSO/stability_analysis/matched_bio_80.rds")
...
saveRDS(lasso_coef, paste0("/rds/general/project/hda_students_data/live/Group7/General/Final/LASSO/stability_analysis/Lasso_stab_comor_cov_bio5/Lasso_stab_comor_cov_bio5_", ichunk, ".rds"))
